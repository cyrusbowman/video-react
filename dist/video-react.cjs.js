    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        (timeSelections || []).map(function (time) {
          return React__default.createElement(TimeSelection, { key: 'TimeSelection' + time, time: time, duration: duration });
        }),
...
exports.NextFrameControl = NextFrameControl;
exports.PreviousFrameControl = PreviousFrameControl;
