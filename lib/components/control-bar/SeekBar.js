...
var _TimeSelection = require('./TimeSelection');

var _TimeSelection2 = _interopRequireDefault(_TimeSelection);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        (timeSelections || []).map(function (time) {
          return _react2.default.createElement(_TimeSelection2.default, { key: 'TimeSelection' + time, time: time, duration: duration });
        }),
