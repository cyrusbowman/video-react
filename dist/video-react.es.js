...
var TimeSelection = function (_Component) {
  inherits(TimeSelection, _Component);

  function TimeSelection(props, context) {
    classCallCheck(this, TimeSelection);

    var _this = possibleConstructorReturn(this, (TimeSelection.__proto__ || Object.getPrototypeOf(TimeSelection)).call(this, props, context));

    _this.getPercent = _this.getPercent.bind(_this);
    return _this;
  }

  createClass(TimeSelection, [{
    key: 'getPercent',
    value: function getPercent() {
      var percent = this.props.time / this.props.duration;
  ...
  createClass(SeekBar, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          timeSelections = _props.timeSelections;
      ...
      return React.createElement(
        ...
        (timeSelections || []).map(function (time) {
          return React.createElement(TimeSelection, { key: 'TimeSelection' + time, time: time, duration: duration });
        }),
...
var NextPrevFrameControl = (function (mode) {
  var NextPrevFrameControl = function (_Component) {
    inherits(NextPrevFrameControl, _Component);

    function NextPrevFrameControl(props, context) {
      classCallCheck(this, NextPrevFrameControl);

      var _this = possibleConstructorReturn(this, (NextPrevFrameControl.__proto__ || Object.getPrototypeOf(NextPrevFrameControl)).call(this, props, context));

      _this.handleClick = _this.handleClick.bind(_this);
      return _this;
    }

    createClass(NextPrevFrameControl, [{
      key: 'handleClick',
      value: function handleClick() {
        var _props = this.props,
            actions = _props.actions,
      ...
      value: function render() {
        ...
        var classNames$$1 = ['video-react-control', 'video-react-button', 'video-react-icon'];
        if (mode === 'forward') {
          classNames$$1.push('video-react-icon-skip-next');
        } else {
          classNames$$1.push('video-react-icon-skip-previous');
        }
        classNames$$1.push('video-react-' + mode + '-control');
        if (this.props.className) {
          classNames$$1.push(this.props.className);
        }
        return React.createElement(
  ...
  NextPrevFrameControl.propTypes = propTypes$30;
  NextPrevFrameControl.defaultProps = defaultProps$10;
  return NextPrevFrameControl;
});

// Pass mode into parent function
var NextFrameControl = NextPrevFrameControl('forward');

NextFrameControl.displayName = 'NextFrameControl';

// Pass mode into parent function
var PreviousFrameControl = NextPrevFrameControl('replay');
